...
The following graph class is implemented specifically for Breadth-First Search and Depth-First Search algorithms, using adjacency lists to represent a graph G = (V, E).
 */
#ifndef GRAPH_H
#define GRAPH_H
